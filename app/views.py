...
from .models import Benefit, Department, Employee, EmployeeHistory, Function, Vyrobek, Sklad
...
appbuilder.add_view(
    VyrobekView, "Vyrobek", icon="fa-folder-open-o", category="Company"
)
appbuilder.add_view(
    SkladView, "Sklad", icon="fa-folder-open-o", category="Company"
)
